...
slug: formats-fichiers-compatibles
...
- Valeur ajoutée : montrer que pouvoir ouvrir un format ne signifie pas pouvoir l'annoter ou l'exporter.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `formats fichiers tablette E Ink`.
- Intention : vérifier formats, annotation, export et DRM.
...
- Sources primaires/officielles utilisées : 5.
...
- Nombre de mots de la page complète : 668 (navigation comprise, utilisé seulement comme signal technique).
