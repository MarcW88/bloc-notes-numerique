...
- Valeur ajoutée : distinguer import/export de fichiers et synchronisation de dossiers.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `bloc-notes numérique Dropbox`.
- Intention : comprendre les fonctions Dropbox selon les écosystèmes.
...
- Nombre de mots de la page complète : 524 (navigation comprise, utilisé seulement comme signal technique).
