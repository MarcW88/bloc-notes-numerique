...
slug: imprimer-notes-numeriques
...
- Valeur ajoutée : faire du PDF le format intermédiaire et contrôler ratio/couleur avant impression.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `imprimer notes numériques`.
- Intention : imprimer proprement des pages manuscrites ou du texte converti.
...
- Nombre de mots de la page complète : 561 (navigation comprise, utilisé seulement comme signal technique).
