...
```yaml
url: /guides/imprimer-notes-numeriques/
...
- Contenu utile hors navigation et hors section Sources : **880 mots**.
- H2 substantiels : **7**.
- Tableaux : **1**.
...
- `L’impression commence par un bon export` — 117 mots ; 3 paragraphe(s) ; 0 tableau(x) ; 0 liste(s).
- `La taille de la page numérique n’est pas forcément du A4` — 129 mots ; 3 paragraphe(s) ; 0 tableau(x) ; 0 liste(s).
- `Quel format imprimer selon le contenu ?` — 120 mots ; 2 paragraphe(s) ; 1 tableau(x) ; 0 liste(s).
- `Attention aux couleurs et niveaux de gris` — 117 mots ; 3 paragraphe(s) ; 0 tableau(x) ; 0 liste(s).
- `Les écosystèmes fournissent déjà les formats nécessaires` — 113 mots ; 3 paragraphe(s) ; 0 tableau(x) ; 0 liste(s).
- `Procédure d’impression fiable` — 95 mots ; 2 paragraphe(s) ; 0 tableau(x) ; 1 liste(s).
- `Quand l’impression doit-elle influencer le choix du bloc-notes ?` — 65 mots ; 2 paragraphe(s) ; 0 tableau(x) ; 0 liste(s).
