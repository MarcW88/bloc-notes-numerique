...
- Valeur ajoutée : refuser les classements en millisecondes sans protocole comparable.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `latence écriture tablette E Ink`.
- Intention : comprendre ce qui crée le délai entre stylet et trait.
...
- Nombre de mots de la page complète : 630 (navigation comprise, utilisé seulement comme signal technique).
