...
slug: organiser-notes-numeriques
...
- Valeur ajoutée : organiser selon la récupération future plutôt que multiplier les dossiers.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `organiser notes numériques`.
- Intention : construire une structure simple pour retrouver et archiver ses notes.
...
- Nombre de mots de la page complète : 584 (navigation comprise, utilisé seulement comme signal technique).
