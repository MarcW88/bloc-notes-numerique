...
- Valeur ajoutée : comparer les fonctions OCR par résultat concret et conditions d'usage.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `OCR manuscrit tablette`.
- Intention : distinguer conversion, recherche manuscrite et PDF recherchable.
...
- Nombre de mots de la page complète : 638 (navigation comprise, utilisé seulement comme signal technique).
