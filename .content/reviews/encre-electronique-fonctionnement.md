...
slug: encre-electronique-fonctionnement
...
- Valeur ajoutée : passer des microcapsules aux conséquences concrètes pour l'usage.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `fonctionnement encre électronique`.
- Intention : expliquer le déplacement des particules, la bistabilité et le rafraîchissement.
...
- Nombre de mots de la page complète : 680 (navigation comprise, utilisé seulement comme signal technique).
