...
- Valeur ajoutée : ajouter la contrainte des politiques IT et distinguer copie de sync.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `bloc-notes numérique OneDrive`.
- Intention : vérifier les flux OneDrive, notamment en environnement Microsoft 365.
...
- Nombre de mots de la page complète : 550 (navigation comprise, utilisé seulement comme signal technique).
