...
- Valeur ajoutée : comparer import, export et sync au lieu d'un simple oui/non.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `bloc-notes numérique Google Drive`.
- Intention : vérifier quels écosystèmes accèdent à Google Drive et dans quel sens.
...
- Nombre de mots de la page complète : 580 (navigation comprise, utilisé seulement comme signal technique).
