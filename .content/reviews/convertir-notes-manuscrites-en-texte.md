...
- Valeur ajoutée : procédure de conversion + conservation de l'original pour vérification.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `convertir notes manuscrites en texte`.
- Intention : transformer un carnet manuscrit en texte éditable.
...
- Nombre de mots de la page complète : 572 (navigation comprise, utilisé seulement comme signal technique).
