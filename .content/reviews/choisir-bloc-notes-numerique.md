...
- Valeur ajoutée : ordonner les critères éliminatoires avant les caractéristiques matérielles.
- Réécriture totale évitée pour les contenus existants ; contenu neuf construit depuis le brief pour les nouvelles pages.

## 2. Search intent

- Requête/topic : `choisir bloc-notes numérique`.
- Intention : choisir une tablette E Ink de prise de notes selon son flux de travail.
...
- Nombre de mots de la page complète : 911 (navigation comprise, utilisé seulement comme signal technique).
