...
TRUST_CONTENT = {
    "/methode-de-test/": r'''
      ...
      <p>Cette distinction est importante pour les bloc-notes numériques : une fiche technique permet de vérifier une taille d'écran, un format d'export ou l'existence d'un abonnement, mais elle ne permet pas à elle seule d'affirmer qu'un stylet « semble naturel », qu'une latence est imperceptible ou qu'un appareil reste agréable après plusieurs semaines d'utilisation.</p>
